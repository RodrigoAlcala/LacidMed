...
def three_gaussians(x, amp1, cen1, sigma1, amp2, cen2, sigma2, amp3, cen3, sigma3, offset):
    ...
    return gauss1 + gauss2 + gauss3 + offset
...
def main():
    ...
    image_1_path = 'C:/Users/santi/Desktop/Volumetria/Slaibe_Yamila/23-TFE/nii/23-TFE.nii'
    ...
    model = Model(three_gaussians)

    # Provide initial guesses for parameters (optional but helps convergence)
    params = model.make_params(
        amp1=0.5, cen1=3, sigma1=0.5,
        amp2=0.4, cen2=6, sigma2=0.8,
        amp3=0.3, cen3=8, sigma3=0.3,
        offset=0.01
    )
    ...
    plt.plot(bin_centers, result.best_fit, label='Fit: Three Gaussians + Offset', color='red')
