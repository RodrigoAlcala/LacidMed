...
sobel_tresholded = segmenter_2.threshold_segmentation(lower_threshold=30)



segmenter_3 = Segmentation(volumetric_array=bg_removed)
tresholded = segmenter_3.threshold_segmentation(lower_threshold=0, upper_threshold=650)
...
axs[1].imshow(sobel_scaled[:, :, 80], cmap='gray')
